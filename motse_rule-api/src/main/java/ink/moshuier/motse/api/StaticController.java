...
import ink.moshuier.motse.service.config.OSSClient;
...
import static ink.moshuier.motse.dao.util.ConstantUtils.IMG_BED_PREFIX;
...
public class StaticController implements RestfulApi {
    @Autowired
