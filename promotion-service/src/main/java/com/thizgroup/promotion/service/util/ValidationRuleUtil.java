package com.thizgroup.promotion.service.util;
...
public class ValidationRuleUtil {
  ...
  /**
   * @Description: 登陆密码规则验证 @Param: [password]
   *
   * @return: java.lang.Boolean @Author: wlf @Date: 2019/5/22
   */
  ...
  /**
   * @Description: 提现密码规则验证 @Param: [password]
   *
   * @return: java.lang.Boolean @Author: wlf @Date: 2019/5/22
   */
  ...
  /**
   * @Description: 手机号码验证 @Param: [password]
   *
   * @return: java.lang.Boolean @Author: wlf @Date: 2019/5/22
   */
