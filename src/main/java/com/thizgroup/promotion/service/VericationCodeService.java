...
import com.thizgroup.promotion.bean.sms.SmsSendRequest;
import com.thizgroup.promotion.bean.sms.SmsSendResponse;
import com.thizgroup.promotion.exception.CommonException;
import com.thizgroup.promotion.exception.ErrorCode;
import com.thizgroup.promotion.exception.JsonException;
import com.thizgroup.promotion.util.*;
...
public class VericationCodeService {
  ...
  public String sendVericationCode(String mobile) {
    ...
    String verifyCode =
        isTest() ? ConstantUtils.TEST_VERIFY_CODE : VericationCodeGenerator.generate();
